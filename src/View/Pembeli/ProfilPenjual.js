...
class ProfilUser extends React.Component{
    ...
    showUser=()=>{
        ...
        fetch(`http://23.97.55.83/be1/Users/Penjual/User/${Username}`,{
            method: "GET",
            header:header,
        }).then(res=>res.json())
        .then(
    ...
    showProdukUser=()=>{
        ...
        var header = new Headers();
            ...
            console.log(Username)
        fetch(`http://23.97.55.83/be1/product/Username/${Username}`,{
            method:"GET",
            header: header,
        }).then(res=>res.json())
        .then(
    ...
    addtocart =()=>{
        ...
        axios.post('http://23.97.55.83/be1/keranjang/addtocart', newCart)
        .then(response =>{
          this.ModalSuccess();
    ...
    LaporkanBarang=()=>{
        const newProduk = new FormData();
            ...
            axios.put('http://23.97.55.83/be1/product/laporkan/'+this.state.form.id_produk,newProduk,config).then(response=>{
    ...
    <div>
        <div style={{margin:"0px"}}>
                ...
                <Form>
                    ...
                    <br/>
                    <div>
                        <img align="right"style={{maxWidth:"70%"}} src={`http://23.97.55.83/be1${User.Foto}`} alt="gambar"/>
                    </div>
                    </Col>
                    </Row>
                </Form>
                        ...
                        {produk && produk.length > 0 ? produk.map(produks=>(
                            <div>
                                ...
                                <CardMedia
                                    ...
                                    image={`http://23.97.55.83/be1${produks.image}`}
                                    title="gambar"
                                    alt="gambar"
                                />
                                <CardContent>
