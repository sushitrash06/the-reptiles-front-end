...
showCart=()=>{
    ...
    var header = new Headers();
        ...
        fetch(`http://23.97.55.83/be1/keranjang/user/${decoded.id_user}/status/dalam keranjang`,{
            method:"GET",
            header:header,
        })
        .then(res=> res.json())
    ...
    deleteCart=()=>{
        axios.delete('http://23.97.55.83/be1/keranjang/delete/'+this.state.form.id_keranjang)
        .then(response=>{
            this.setState({
                ModalDelete: false
            })
