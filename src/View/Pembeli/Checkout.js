    ...
    constructor(){
        ...
        componentDidMount =()=>{
            ...
            var header = new Headers();
                ...
                fetch(`http://23.97.55.83/be1/keranjang/view/${id_keranjang}`,{
                    method:"GET",
                    header:header,
                })
                .then(res=> res.json())
            ...
            deleteCart(){
                    axios.delete('http://23.97.55.83/be1/keranjang/delete/'+this.state.id_keranjang)
                    .then(response=>{
            ...
            AddOrder(){
                ...
                if( !document.getElementById('alamat').value || !document.getElementById('nomer').value ){
                    ...
                    axios.post('http://23.97.55.83/be1/pesanan/tambah_pesanan',newOrder)
                    .then(response=>{
                        this.ModalSuccess();
                        this.deleteCart();
