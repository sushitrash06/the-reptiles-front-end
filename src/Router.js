...
import DaftarReptilAwal from './View/DaftarHewanDilindungi';
import DaftarReptilPembeli from './View/Pembeli/Dilarang';
        ...
        return(
            <Router history={history}>
                <Switch>
                    ...
                    <Route path ="/DaftarDilindungiIndex" component={DaftarReptilAwal}/>
                    <Route path ="/DaftarDilindungiPembeli" component={DaftarReptilPembeli}/>
                </Switch>
            </Router>
        ) 
